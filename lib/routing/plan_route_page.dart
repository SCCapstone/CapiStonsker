...
class PlanRoutePage extends StatefulWidget {
  ...
  PlanRoutePage({Key? key, required this.list, required this.counties, required this.searchText, required this.controller}) : super(key: key);
      ...
      layers: [
        ...
        MarkerLayerOptions(
          markers:
              ...
              ) + selectList().map((m) => mBox.createMapMarker(context, m, false)).toList(),
        ),
        userLocationOptions,
